...
GET /api/v1/indicators/{symbol}/{timeframe} → IndicatorBundle
...
@router.get("/{symbol}/{timeframe}", response_model=IndicatorBundle)
...
async def get_indicators(
    ...
    """Bir sembol+TF için tüm trend & momentum indikatörlerini hesapla.
